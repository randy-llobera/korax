...
| ---------------------------------- | ---------- | ------ | ---------- |
| `/src/auth.ts/credentials` (login) | 5 attempts | 15 min | IP + email |
| `/api/auth/register`               | 3 attempts | 1 hour | IP         |
| `/api/auth/password/forgot`        | 3 attempts | 1 hour | IP         |
| `/api/auth/password/reset`         | 5 attempts | 15 min | IP         |
| `/api/auth/verification/resend`    | 3 attempts | 15 min | IP + email |
...
- Inspect any other route that should be protected with rate limiting and advise
