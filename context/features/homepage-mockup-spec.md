# Korax Homepage Mockup Spec

Create a marketing homepage for Korax - a developer knowledge hub for code snippets, AI prompts, commands, notes, files, images, and links.
...
A box labeled "...with Korax" showing a simplified dashboard mockup:
